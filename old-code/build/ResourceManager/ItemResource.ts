...
namespace Sakura {
    export class ItemResource{
        ...
        constructor(modelPath:string = __dir__ + "resources/assets/" + Main.MODID + "/models/item/",langPath:string = __dir__ + "resources/assets/" + Main.MODID + "/lang/",config?:any){
        ...
        hasModel(id:string):boolean{
            let model:any = this.getModel(id);
            try{
                return model.elements || model.parent.split(":")[0] === Main.MODID;
            }
            catch(e){
                return false;
            }
