...
declare namespace BlockRenderer {
    function Model():any
    function enableCoordMapping(...any):any
    function mapAtCoords(...any):any
    function unmapAtCoords(...any):any
}
...
declare namespace TileEntity {
    ...
    function destroyTileEntity(any);
    /**
...
declare interface TileEntity {
    ...
    liquidStorage: any,
    destroyBlock : (any,any) => void,
    selfDestroy: () => void;
    onItemClick:(id:number,count:number,data:number,coords:Callback.ItemUseCoordinates) => void;
}
...
declare interface TileEntityPrototype {
     ...
     */
    getGuiScreen?: () => UI.IWindow | undefined;
